...
import { deleteEntity, getEntity } from './cart.reducer';
...
export const CartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fShopApp.cart.delete.question">
        <Translate contentKey="fShopApp.cart.delete.question" interpolate={{ id: cartEntity.id }}>

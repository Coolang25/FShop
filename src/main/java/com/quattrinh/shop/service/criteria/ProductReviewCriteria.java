...
/**
 * Criteria class for the {@link com.quattrinh.shop.domain.ProductReview} entity. This class is used
 * in {@link com.quattrinh.shop.web.rest.ProductReviewResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-reviews?id.greaterThan=5&attr1.contains=something&attr2.specified=false}

...
import reducer, {
  ...
  reset,
  updateEntity,
} from './product-attribute-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTATTRIBUTEVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTATTRIBUTEVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTATTRIBUTEVALUE actions', async () => {
      const arg = 42666;

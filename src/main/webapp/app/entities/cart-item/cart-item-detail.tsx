    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cartItemDetailsHeading">
          <Translate contentKey="fShopApp.cartItem.detail.title">CartItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="fShopApp.cartItem.cart">Cart</Translate>
          </dt>
          <dd>{cartItemEntity.cart ? cartItemEntity.cart.id : ''}</dd>
          <dt>
            <Translate contentKey="fShopApp.cartItem.variant">Variant</Translate>
          </dt>
          <dd>{cartItemEntity.variant ? cartItemEntity.variant.sku : ''}</dd>
        </dl>

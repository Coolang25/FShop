  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fShopApp.cart.home.createOrEditLabel" data-cy="CartCreateUpdateHeading">
            <Translate contentKey="fShopApp.cart.home.createOrEditLabel">Create or edit a Cart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fShopApp.cart.createdAt')}
                id="cart-createdAt"
                name="createdAt"
                data-cy="createdAt"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('fShopApp.cart.updatedAt')}
                id="cart-updatedAt"
                name="updatedAt"
                data-cy="updatedAt"
                type="datetime-local"
                placeholder="YYYY-MM-DD HH:mm"
              />
              <ValidatedField id="cart-user" name="user" data-cy="user" label={translate('fShopApp.cart.user')} type="select">
                <option value="" key="0" />
                {users

  ...
  return (
    <div>
      <h2 id="product-image-heading" data-cy="ProductImageHeading">
        <Translate contentKey="fShopApp.productImage.home.title">Product Images</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fShopApp.productImage.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-image/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fShopApp.productImage.home.createLabel">Create new Product Image</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productImageList && productImageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fShopApp.productImage.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('url')}>
                  <Translate contentKey="fShopApp.productImage.url">Url</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('url')} />
                </th>
                <th className="hand" onClick={sort('isMain')}>
                  <Translate contentKey="fShopApp.productImage.isMain">Is Main</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('isMain')} />
                </th>
                <th>
                  <Translate contentKey="fShopApp.productImage.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productImageList.map((productImage, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{productImage.isMain ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fShopApp.productImage.home.notFound">No Product Images found</Translate>
            </div>
          )
        )}
      </div>

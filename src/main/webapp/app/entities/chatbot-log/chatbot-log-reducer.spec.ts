...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATBOTLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHATBOTLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHATBOTLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHATBOTLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHATBOTLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHATBOTLOG actions', async () => {
      const arg = 42666;

...
import { createEntity, getEntity, reset, updateEntity } from './product-attribute.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fShopApp.productAttribute.home.createOrEditLabel" data-cy="ProductAttributeCreateUpdateHeading">
            <Translate contentKey="fShopApp.productAttribute.home.createOrEditLabel">Create or edit a ProductAttribute</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fShopApp.productAttribute.name')}

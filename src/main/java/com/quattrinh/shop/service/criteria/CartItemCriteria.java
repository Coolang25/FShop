...
/**
 * Criteria class for the {@link com.quattrinh.shop.domain.CartItem} entity. This class is used
 * in {@link com.quattrinh.shop.web.rest.CartItemResource} to receive all the possible filtering options from
...
public class CartItemCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, quantity, price, cartId, variantId, distinct);
    }

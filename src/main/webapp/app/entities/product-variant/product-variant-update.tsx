  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fShopApp.productVariant.home.createOrEditLabel" data-cy="ProductVariantCreateUpdateHeading">
            <Translate contentKey="fShopApp.productVariant.home.createOrEditLabel">Create or edit a ProductVariant</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fShopApp.productVariant.sku')}
              ...
              />
              <ValidatedField
                label={translate('fShopApp.productVariant.price')}
              ...
              />
              <ValidatedField
                label={translate('fShopApp.productVariant.stock')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('fShopApp.productVariant.product')}
                type="select"
              >
                <option value="" key="0" />
                {products

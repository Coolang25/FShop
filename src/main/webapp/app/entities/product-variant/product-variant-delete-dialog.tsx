...
export const ProductVariantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="fShopApp.productVariant.delete.question">
        <Translate contentKey="fShopApp.productVariant.delete.question" interpolate={{ id: productVariantEntity.id }}>

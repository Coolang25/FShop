...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHOPORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SHOPORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SHOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SHOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SHOPORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SHOPORDER actions', async () => {
      const arg = 42666;

...
import com.quattrinh.shop.service.ProductVariantQueryService;
import com.quattrinh.shop.service.ProductVariantService;
import com.quattrinh.shop.service.criteria.ProductVariantCriteria;
...
/**
 * REST controller for managing {@link com.quattrinh.shop.domain.ProductVariant}.
 */
@RestController
...
public class ProductVariantResource {
    ...
    public ResponseEntity<List<ProductVariantDTO>> getAllProductVariants(
        ProductVariantCriteria criteria,

...
/**
 * Criteria class for the {@link com.quattrinh.shop.domain.OrderItem} entity. This class is used
 * in {@link com.quattrinh.shop.web.rest.OrderItemResource} to receive all the possible filtering options from
...
public class OrderItemCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, quantity, price, orderId, variantId, distinct);
    }

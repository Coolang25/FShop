...
import reducer, {
  ...
  reset,
  updateEntity,
} from './product-attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTATTRIBUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTATTRIBUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTATTRIBUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTATTRIBUTE actions', async () => {
      const arg = 42666;

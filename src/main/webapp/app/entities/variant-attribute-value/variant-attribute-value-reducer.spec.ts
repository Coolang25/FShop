...
import reducer, {
  ...
  reset,
  updateEntity,
} from './variant-attribute-value.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIANTATTRIBUTEVALUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VARIANTATTRIBUTEVALUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VARIANTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VARIANTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VARIANTATTRIBUTEVALUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VARIANTATTRIBUTEVALUE actions', async () => {
      const arg = 42666;

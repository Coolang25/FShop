...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTREVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTREVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTREVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTREVIEW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTREVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTREVIEW actions', async () => {
      const arg = 42666;
